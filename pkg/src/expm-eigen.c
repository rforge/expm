 ...
 *  i.e. function 'modLa_rg' and 'modLa_dgesv' in modules/lapack/lapack.c, used in eigen.R.
 */
...
void expm_eigen(double *x, int n, double *z, double tol)
{
    ...
    else
    {
        ...
        /*F77_CALL(zgecon)("1", &n, eigvect, &n, &onenorm, &rcond, worksing, rworksing, &info);
        ...
        if (is_diag) 
        {
            ...
            expm(x, n, z); //call expm function i.e. Ward(1977) algorithm
